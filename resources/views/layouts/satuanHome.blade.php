...
@section('content')
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-info">
            <div class="modal-header">
              <h4 class="modal-title">Data Satuan Obat</h4>
            ...
            <div class="modal-body">
              {{-- isian --}}
              <form action="{{ route('satuan.store') }}" method="post" id="forms">
                @csrf
                <div class="form-group">
                    ...
                    <input type="text" hidden class="form-control" id="id" name="id" placeholder="Satuan Obat">
                </div>
            </div>
    ...
    $(document).on('click', '.edit', function () {
        $('#forms').attr('action', "{{ route('satuan.updates') }}")
        let id = $(this).attr('id')
        $.ajax({
            url : "{{ route('satuan.edits') }}",
            type : 'post',
            data : {
                id : id,
                _token : "{{ csrf_token() }}"
