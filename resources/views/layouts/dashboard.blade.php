...
<div class="wrapper">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/jualans" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tambah Penjualan Obat</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('jualans.home') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Laporan Penjualan Obat</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/pembelians" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pembelian Obat</p>
                </a>
              </li>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2023 Fariska R</strong>
    All rights reserved.
  </footer>
